...
from .ResFilters import *
from ..net_util import init_net


class ResPIFuNet(BasePIFuNet):
    '''
    ResNet PIFu network uses Hourglass stacks as the image filter.
    ...
    def __init__(self,
        ...
        super(ResPIFuNet, self).__init__(
        ...
        self.image_filter = ResFilter(opt)
